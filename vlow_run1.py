...
if __name__ == '__main__':
    ...
    if args.eval_quality_dir != '':
        ...
        for s in range(args.n_eval):
            ...
            sde_sigma = f'_{args.cond_vel_sigma}' if args.sde else ''
            syn_file = f'{args.method}_{s}_{args.cond_vel}_{args.var_weight}{sde_sigma}'
